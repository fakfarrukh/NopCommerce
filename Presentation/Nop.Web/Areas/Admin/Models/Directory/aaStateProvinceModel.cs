...
namespace Nop.Web.Areas.Admin.Models.Directory
{
    ...
    /// </summary>
    public partial record aaStateProvinceModel : BaseNopEntityModel, ILocalizedModel<StateProvinceLocalizedModel>
    {
        #region Ctor

        public aaStateProvinceModel()
        {
        ...
        [NopResourceDisplayName("Admin.Configuration.Countries.States.Fields.ArabicName")]
